...
docker run --gpus all -it -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/j/workspace:/home/jd/workspace -e DISPLAY=$DISPLAY -p 8887:8888 -p 9997:9998 --shm-size=2G --name py3tf241 cu11-4_nn8_2004 bash
